...
class BlogPostDAO:
    ...
    def get_post_by_permalink(self, permalink):
        ...
        try:
            # XXX HW 3.2 Work Here to insert the post
            print "Searching for post by permalink"
            # Works
    ...
    def add_comment(self, permalink, name, email, body):
        ...
        try:
            ...
            updatednum = self.posts.find({'permalink':permalink}).count()
            self.posts.update({'permalink':permalink},{'$push':{'comments':comment}}, multi=False)
